    ...
    <div className="about" id="about">
      <div className="container">   <div className="imgContainer">
        ...
        <div className="textContainer">
          ...
          I'm a passionate fullstack development student at Medieinstitutet, graduating in April. I thrive on solving problems and transforming ideas into elegant, functional solutions through code.
          </p>
          <p className="presentationText">
